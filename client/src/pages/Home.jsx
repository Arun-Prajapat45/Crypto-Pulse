...
export default function Home() {
  ...
  const displayedCoins = showAllCoins ? COINS : COINS.slice(0, 6);
        ...
        {COINS.length > 6 && (
          <div className="mt-6 flex justify-center">
            <button
              ...
              className={`rounded-full border px-6 py-3 text-sm font-semibold transition hover:border-accent hover:bg-accent/10 ${isDark ? 'border-white/10 text-white' : 'border-gray-300 text-gray-700'}`}
            >
              {showAllCoins ? (
                <>
                ...
                <>
                  ...
                  Show More Coins ({COINS.length - 6})
                </>
              )}
            </button>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-12">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <a href="mailto:arun.op.prajapati@gmail.com" className={`w-9 h-9 rounded-lg border flex items-center justify-center hover:text-accent hover:border-accent transition-all ${isDark ? 'bg-white/5 border-white/10 text-slate-400' : 'bg-gray-100 border-gray-200 text-gray-500'}`} title="Email">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </a>
                <a href="https://github.com/Arun-Prajapat45" target="_blank" rel="noopener noreferrer" className={`w-9 h-9 rounded-lg border flex items-center justify-center hover:text-accent hover:border-accent transition-all ${isDark ? 'bg-white/5 border-white/10 text-slate-400' : 'bg-gray-100 border-gray-200 text-gray-500'}`} title="GitHub">
                ...
                <a href="https://www.linkedin.com/in/arun-prajapat-671b442a0/" target="_blank" rel="noopener noreferrer" className={`w-9 h-9 rounded-lg border flex items-center justify-center hover:text-accent hover:border-accent transition-all ${isDark ? 'bg-white/5 border-white/10 text-slate-400' : 'bg-gray-100 border-gray-200 text-gray-500'}`} title="LinkedIn">
          ...
          <div className={`mt-12 pt-8 border-t ${isDark ? 'border-white/5' : 'border-gray-200'}`}>
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-sm text-slate-500">
                © {new Date().getFullYear()} CryptoPulse. Built with ❤️ by Arun Prajapat.
              </div>
